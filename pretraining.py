...
# DATASET
#create_dataset(num_samples=21000,data_path='./Data_Source',resize=(1080,1080))
train_dataloader,valid_dataloader,classes,_= load_data(batch_size=32,dataset_path='WikiArt') 
